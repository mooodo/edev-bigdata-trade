...
object UpdateUtils {
  ...
  def updatePartitionTable(spark:SparkSession, param:UpdateParam): Unit = {
    ...
    def overwriteHitTable(spark:SparkSession, param:UpdateParam) = {
  ...
  def getDescription(spark:SparkSession, schema: String, table: String) = {
    import spark.implicits._
    val sql = new StringBuilder
  ...
  def getColumns(spark:SparkSession, schema: String, table: String) = {
    import spark.implicits._
    val sql = new StringBuilder
    val desc = spark.sql(s"desc ${schema}.${table}")
